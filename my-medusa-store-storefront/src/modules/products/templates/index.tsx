...
//                               <div className="details_slider_nav_item">
//                                 <img src={img.url} alt={product.title} className="img-fluid w-100" />
//                               </div>
//                             </div>
//                           ))}
//                         </div>
...
//                           <div className="col-12">
//                             <div className="details_slider_thumb_item">
//                               <img src={mainImage} alt={product.title} className="img-fluid w-100" />
//                             </div>
//                           </div>
//                         </div>
//                       </div>
...
//                 <div className="col-lg-6 wow fadeInUp">
//                   <div className="shop_details_text">
//                     <p className="category">{product.collection?.title || product.categories?.[0]?.name || "Category"}</p>
//                     <h2 className="details_title">{product.title}</h2>
//                     <div className="d-flex flex-wrap align-items-center">
//                       <p className="stock">{product.status === "published" ? "In Stock" : "Out of Stock"}</p>
//                       <p className="rating">
//                         <i className="fas fa-star"></i>
//                         <i className="fas fa-star"></i>
//                         <i className="fas fa-star"></i>
...
//                     <h3 className="price" style={{ fontSize: "2rem", fontWeight: "bold" }}>
//                     {cheapestPrice?.calculated_price ? (
//                         <>
//                         <span style={{ fontSize: "2.0rem", fontWeight: "bold", color: "#090909" }}>
//                             {cheapestPrice.calculated_price}
//                         </span>
...
//                       <div className="details_single_variant">
//                         <p className="variant_title">Variants:</p>
//                         <ul className="details_variant_size">
...
//                       </div>
//                       <div className="details_btn_area">
//                         <a className="common_btn buy_now" href="#">Buy Now <i className="fas fa-long-arrow-right"></i></a>
//                         {/* <a className="common_btn" href="#" >Add to cart <i className="fas fa-long-arrow-right"></i></a> */}
...
//                       <li><span>Tag:</span> {product.tags?.map(t => t.value).join(", ") || "N/A"}</li>
//                     </ul>
//                   </div>
//                 </div>
//               </div>
...
//                             <img src="/assets/images/beauty_pro_1.png" alt="Product" className="img-fluid w-100"/>
...
//                             <a className="title" href="#">Maayas Mitti - The Indian Attar Perfume - 15 ml</a>
//                             <p className="price">₹345.00 <del>₹405.00</del></p>
//                             <p className="rating">
//                                 <i className="fas fa-star"></i>
//                                 <i className="fas fa-star"></i>
//                                 <i className="fas fa-star"></i>
...
//                     <div className="product_item_2 product_item">
//                         <div className="product_img">
//                             <img src="assets/images/beauty_pro_2.png" alt="Product" className="img-fluid w-100"/>
//                             <ul className="discount_list">
...
//                     <div className="product_item_2 product_item">
//                         <div className="product_img">
//                             <img src="assets/images/beauty_pro_3.png" alt="Product" className="img-fluid w-100"/>
//                             <ul className="discount_list">
...
//                         </div>
//                         <div className="product_text">
//                             <a className="title" href="#">Kid's Western Party Dress</a>
//                             <p className="price">₹345.00 <del>₹405.00</del></p>
//                             <p className="rating">
//                                 <i className="fas fa-star"></i>
//                                 <i className="fas fa-star"></i>
