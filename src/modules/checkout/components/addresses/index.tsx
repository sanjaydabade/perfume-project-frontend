...
const Addresses = ({
  ...
  return (
    <div className="bg-white checkout_address_area">
      <div className="checkout_header mb-6">
        <h3>Shipping Information</h3>
        {customer ? (
          <p className="flex items-center gap-2 text-sm text-ui-fg-subtle">
            ...
            Account: <b className="ml-1">{customer.first_name} {customer.last_name}</b>
          </p>
        ) : null}
      </div>
      ...
      {isOpen ? (
        <form action={formAction} className="checkout_form_area">
          <div className="pb-8">
            <ShippingAddress
              customer={customer}
